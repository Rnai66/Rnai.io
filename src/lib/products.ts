...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    id: "rnai-cli",
    name: "Rnai-CLI",
    tagline: "Your own AI agent that runs on your machine — chat, agent tasks, scheduled workers",
    taglineTh: "AI agent ส่วนตัวที่รันบนเครื่องคุณเอง — แชท สั่งงาน agent ตั้งเวลาอัตโนมัติ",
    version: "0.1.0",
    platforms: ["mac", "windows"],
    tier: "free",
    icon: "⌨️",
    iconImg: "/apps/rnai-cli.png",
    color: "#0B3945",
    downloads: {
      mac: "https://github.com/Rnai-io/Rnai-CLI/archive/refs/heads/main.zip",
      windows: "https://github.com/Rnai-io/Rnai-CLI/archive/refs/heads/main.zip",
    },
    webApp: "https://rnai-cli.netlify.app/demo.html",
    landing: "https://rnai-cli.netlify.app",
  },
  {
    id: "lotterymap",
    name: "LotteryMap",
